...
@language_versions = []
@languages.keys.each do |language_name|
  last_name = language_name
	@languages[language_name][:versions].each do |pair|
	  @language_versions << [ last_name, pair.first ]
    last_name = pair.first
  end
end
